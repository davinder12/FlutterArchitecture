...
class FoodListData extends BaseStatefulWidget{
  @override
  State<StatefulWidget> get layoutRes => _FoodListDataState();
}

class _FoodListDataState extends BaseListWidget<FoodListData>{

  final PagingController<int, FoodList> pagingController = PagingController(firstPageKey: 0);

  @override
  Widget build(BuildContext context) {
    final dashboardProvider = Provider.of<FoodListModel>(context,listen: true);
